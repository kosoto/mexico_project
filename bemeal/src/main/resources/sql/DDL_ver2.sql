...
CREATE TABLE ARTICLE(
	...
	URL VARCHAR(255),
	BOARD_SEQ INT,
	MEMBER_ID VARCHAR(20) DEFAULT ('알수 없음'),
	ITEM_SEQ INT,
	FOREIGN KEY (BOARD_SEQ) REFERENCES BOARD (BOARD_SEQ),
	FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER (MEMBER_ID) ON DELETE SET DEFAULT,
	FOREIGN KEY (ITEM_SEQ) REFERENCES ITEM (ITEM_SEQ) ON DELETE SET DEFAULT
);
