...
yoonho.service=(()=>{
	var list =x=>{
		...
		$.getScript($.script()+"/ui/y_item_detail.js").done(()=>{
			for(let i = 1; i<4 ; i++){
				$list = $('<div/>').html(y_item_detailUI(i)).appendTo('#content')
			}
	...
	var popup =x=>{
		...
		//modal main
		let $div1 = $('<div/>').attr({id:'y_item_detailUI'}).addClass('container yh-mfp-wrap yh-white-popup');// class : container
		let $div2 = $('<div/>').addClass('yh-mfp-container detail-main')
					.append($('<span/>').addClass('col')
						.append($('<img src="/web/resources/img/yoonho/maehwa_chicken.jpg"/>').addClass('rounded y_img_popup img-fluid')))
						.append($('<div/>').addClass('row')
							...
							.append($('<div/>').addClass('mgt50-mgb50').html($carousel))
						)
		...
		let $span6_1 = $('<div/>').addClass('col-lg-8 mgt50-mgb50')// y_img_popup_div
						.append( 
							...
							.appendTo($div5_1);
		let $div6_1_1 =	$commentHead
						.append($star)
						.append($comment).appendTo($span6_1);
		...
		let $div6_2_1 = $commentHead
						.append($star)
						.append($comment).appendTo($span6_2)
		//commentbox ed
